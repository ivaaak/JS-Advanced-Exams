...
describe('Repository', () => {
    ...
    let clonedEntity = { name: "Pesho", age: 22, birthday: new Date(1998, 0, 7)};
    ...
    describe('Add entity', () => {
        ...
        it('Should throw if updating with invalid entity', () => {
            let entity = { name: "Pesho", age: 22, };
            let entity1 = { name: "Pesho", birthday: new Date(1998, 0, 7) }
            let entity2 = { age: 22, birthday: new Date(1998, 0, 7) }
            let repository = new Repository(properties);
        ...
        it('Should throw error if property has other type', () => {
            let entity = {name: "Pesho", age: 22, birthday: '1998-01-06T22:00:00.000Z',};
            let repository = new Repository(properties);
    ...
    describe('Update', () => {
        it('Should update one valid entity with anouther', () => {
            let newEntity = { name: "Gosho", age: 32, birthday: new Date(1999, 0, 7) };
        ...
        it('Should validate when updating', () => {
            let invalidEntity1 = { age: 22, birthday: new Date(1998, 0, 7) };
            let invalidEntity2 = { name: "Pesho", birthday: new Date(1998, 0, 7) };
            let invalidEntity3 = { name: "Pesho", age: 22, };
            let repo = new Repository(properties);
            repo.add(entity);
